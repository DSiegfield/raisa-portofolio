...
export const galleryImages: imageGalleryType[] = [
  {
    id: 0,
  ...
  },
  {
    ...
    src: "/images/Celular_iPhone_11_Mockup_PSD_logo.png",
    alt: "Celular_iPhone_11_Mockup_PSD_logo.png",
    name: "Celular IPhone 11 Mock Up",
    description: "",
  },
  {
    id: 6,
    src: "/images/Firefly_MockUp_Person.png",
    alt: "Firefly_MockUp_Person.png",
    name: "Mulher Segurando o Telemóvel",
    description:
      "Esse mockup foi selecionado de um banco de dados do Adobe e ajustado no Photoshop. Para inserir o print do aplicativo, desenhei o espaço necessário com a ferramenta de Retângulo. Em seguida, criei uma camada dedicada para a imagem e a converti em um Smart Object, finalizando a composição com um toque profissional.",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    alt: "mockup_app.png",
    name: "Mockup de Homem Segurando Telemóvel na praia",
    description:
      "Este mockup foi coletado de um banco de dados do Adobe e personalizado no Photoshop. Um print do aplicativo foi inserido utilizando a ferramenta Rectangle Tool para desenhar o espaço onde a imagem ficaria. Uma camada foi criada para acomodar a imagem, que foi convertida em um Smart Object, resultando em uma composição finalizada e profissional.",
  },
  {
    id: 9,
    src: "/images/mockup_motorista.png",
    alt: "mockup_motorista.png",
    name: "Mockup de Motorista de aplicativo",
    description:
      "Este mockup foi obtido de um banco de dados do Adobe e customizado no Photoshop. Para inserir o print do aplicativo, utilizei a ferramenta de Retângulo para definir o espaço exato onde a imagem seria posicionada. Em seguida, criei uma camada específica para a imagem, que foi convertida em um Smart Object, resultando em uma composição final e profissional.",
  },
  {
    id: 10,
    src: "/images/mask_jarbas.png",
    alt: "mask_jarbas.png",
  ...
  {
    id: 11,
    src: "/images/mask_jarbas_updated.png",
